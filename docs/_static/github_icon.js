document.addEventListener("DOMContentLoaded", function () {
  ...
  githubLink.className = "github-repo-link muted-link";
  githubLink.href = "https://github.com/NVlabs/parrot/";
  githubLink.target = "_blank";
  githubLink.rel = "noopener noreferrer";
  githubLink.title = "GitHub repository";
  githubLink.innerHTML =
    '<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" aria-hidden="true">' +
  ...
  container.insertBefore(githubLink, container.firstChild);
});
